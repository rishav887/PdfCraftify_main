...
const PrivacyPolicyContent: React.FC<{ closePrivacyModal: () => void }> = ({ closePrivacyModal }) => (
  <div>
...
const TermsOfServiceContent: React.FC<{ closeTermsModal: () => void }> = ({ closeTermsModal }) => (
  <div>
    ...
    <ul>
      ...
      <li>Transmit any material that is abusive, harassing, obscene, or otherwise objectionable</li>
      <li>Attempt to gain unauthorized access to our computer systems or engage in any activity that disrupts, diminishes the quality of, interferes with the performance of, or impairs the functionality of our website.</li>
    </ul>
  ...
  return (
    <>
      <footer className="bg-gray-900 text-white p-8">
        ...
        >
          <PrivacyPolicyContent closePrivacyModal={closePrivacyModal} />
        </Modal>
        ...
        >
          <TermsOfServiceContent closeTermsModal={closeTermsModal} />
        </Modal>
      </footer>
    </>
  );
